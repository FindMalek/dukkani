...
/**
 * Legacy compatibility: Export routes object for backward compatibility during migration
 * @deprecated Use RoutePaths and getRoutePath/getRouteHref instead
 */
export const routes = {
	auth: {
		login: RoutePaths.AUTH.LOGIN,
		signin: RoutePaths.AUTH.SIGNIN,
		signup: RoutePaths.AUTH.SIGNUP,
	},
	dashboard: {
		overview: RoutePaths.DASHBOARD,
		products: {
			index: RoutePaths.PRODUCTS.INDEX,
			detail: RoutePaths.PRODUCTS.DETAIL,
			create: RoutePaths.PRODUCTS.NEW,
			edit: RoutePaths.PRODUCTS.EDIT,
		},
		orders: {
			index: RoutePaths.ORDERS.INDEX,
			detail: RoutePaths.ORDERS.DETAIL,
			create: RoutePaths.ORDERS.NEW,
		},
		settings: {
			index: RoutePaths.SETTINGS.INDEX,
			profile: RoutePaths.SETTINGS.PROFILE,
			storefront: RoutePaths.SETTINGS.STOREFRONT,
			payments: RoutePaths.SETTINGS.PAYMENTS,
			store: {
				index: RoutePaths.SETTINGS.STORE.INDEX,
				detail: RoutePaths.SETTINGS.STORE.DETAIL,
				create: RoutePaths.SETTINGS.STORE.CREATE,
				edit: RoutePaths.SETTINGS.STORE.EDIT,
			},
		},
		customers: {
			index: RoutePaths.CUSTOMERS.INDEX,
			detail: RoutePaths.CUSTOMERS.DETAIL,
			create: RoutePaths.CUSTOMERS.NEW,
			edit: RoutePaths.CUSTOMERS.EDIT,
		},
	},
} as const;
