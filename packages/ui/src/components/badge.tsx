	...
	"inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-full border px-2 py-0.5 font-medium text-xs transition-[color,box-shadow] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3",
	{
		variants: {
			variant: {
				...
				statusSuccess:
					"before:content-[''] before:block before:size-1.5 before:rounded-full before:bg-primary before:shrink-0 border-transparent bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary [a&]:hover:bg-primary/20",
				statusMuted:
					"before:content-[''] before:block before:size-1.5 before:rounded-full before:bg-muted-foreground before:shrink-0 border-transparent bg-secondary/50 text-muted-foreground [a&]:hover:bg-secondary/70",
			},
			size: {
