...
/**
 * Database migration configuration for test-db-migration
 */
interface TestDbMigrationMigrationConfig {
...
/**
 * test-db-migration migration
 */
export class TestDbMigrationMigration extends BaseMigration {
	...
	async validatePrerequisites(): Promise<void> {
		...
		logger.info("Validating prerequisites for test-db-migration");
	...
	async execute(): Promise<MigrationResult> {
		...
		logger.info("Starting database migration: test-db-migration");
	...
	async rollback(): Promise<MigrationResult> {
		const startTime = Date.now();
		logger.info("Rolling back database migration: test-db-migration");
